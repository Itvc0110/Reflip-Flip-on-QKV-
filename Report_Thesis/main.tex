...
\AtBeginBibliography{\sloppy\emergencystretch=4em}
...
\def \AUTHOR{Lưu Thiện Việt Cường}
...
\titleformat
    ...
    {} % before
    [] % after
\titlespacing*{\subsection}{0pt}{0.8\parskip}{0.25\parskip}
...
\titleformat
    ...
    {} % before
    [.] % after
\titlespacing*{\subsubsection}{0pt}{0.75\parskip}{0.6em}
...
\graphicspath{{Figure/}{figures/}{../figures/}} % Thư mục chứa các hình ảnh
...
\setcounter{tocdepth}{1} % Show chapters and sections only in the table of contents
...
% The abbreviation list is intentionally hidden in the final thesis output.
% Glossary definitions remain loaded so acronym commands can still be used.
% \glsaddall
...
\iffalse
% Hide the standalone APPENDIX notice page while keeping appendix chapters.
% \appendixpage
\appendix
% \addappheadtotoc
